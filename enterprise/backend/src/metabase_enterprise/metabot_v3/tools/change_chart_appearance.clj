...
(deftool change-chart-appearance
  :invoke (fn [args _context] args)
  :reactions (fn [{goal :goal, trend-line :trend-line, data-labels :data-labels, total :total, stack-type :stack-type, max-series-count :max-series-count, axes-labels :axes-labels, y-axis-range :y-axis-range}]
